...
use App\Models\TourOperations\LuzonExclusive;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Validator;

class LuzonExclusiveController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        try {
            $query = LuzonExclusive::query();
            ...
            return response()->json([
                'success' => true,
                'message' => 'Luzon exclusive tours retrieved successfully',
                'data' => $tours
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Failed to retrieve Luzon exclusive tours',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $tour = LuzonExclusive::create($validator->validated());

            return response()->json([
                'success' => true,
                'message' => 'Luzon exclusive tour created successfully',
                'data' => $tour
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Failed to create Luzon exclusive tour',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    {
        try {
            $tour = LuzonExclusive::find($id);

            if (!$tour) {
                return response()->json([
                    'success' => false,
                    'message' => 'Luzon exclusive tour not found'
                ], 404);
            }

            return response()->json([
                'success' => true,
                'message' => 'Luzon exclusive tour retrieved successfully',
                'data' => $tour
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Failed to retrieve Luzon exclusive tour',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Luzon exclusive tour updated successfully',
                'data' => $tour
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Failed to update Luzon exclusive tour',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Luzon exclusive tour deleted successfully'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Failed to delete Luzon exclusive tour',
                'error' => $e->getMessage()
            ], 500);
        }
    }
